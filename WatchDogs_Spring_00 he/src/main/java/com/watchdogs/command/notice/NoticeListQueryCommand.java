...
public class NoticeListQueryCommand implements BCommand_new {
	...
	public void execute(SqlSession sqlSession, Model model, HttpSession httpSession) {
		...
		System.out.println("NoticeListQueryCommand 성공");
		...
		//----------query문 완료
		model.addAttribute("noticelist",dao.noticeListQuery(request.getParameter("searchCategory"), request.getParameter("searchWord"),offset, numOfTuplesPerPage));
