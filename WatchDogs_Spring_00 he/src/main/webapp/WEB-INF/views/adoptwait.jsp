    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" >
			...
			<li class="gnb_1dli" style="z-index:998">
			    <a href="adopt" class="gnb_1da gnb_1dam">입양</a>
 ...
 <h1>입양 가능 카테고리</h1>   
   ...
   <nav> 
    ...
    <br>
       ...
       <div class = "logo-baer"></div>
       
       <div class="bn-box-1 con"></div>
       ...
       <div class ="list-box-1 con">
        ...
        <li class = "cell">
        <div class = "img-box">
        <a href="adoptwait_02?dogid=${dto.dogid}"><img width="200" height="200" src="dog/${dto.dogfilepath}"></a></div>
