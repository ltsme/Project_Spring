...
<div id="wrapper">
 ...
 <form action="adoptcompleteSearch">
    <br>
    <br>
    ...
    <br>
       ...
       <div class ="list-box-1 con">
        ...
        <li class = "cell">
        <div class = "img-box">
        <a href="adoptcomplete_02?dogid=${dto.dogid}"><img width="200" height="200" src="dog/${dto.dogfilepath}"></a></div>
     ...
     <div class = "center_box"><%for(int i = startPage; i<=endPage; i++){ %>
         ...
         <a href="adoptcomplete?pageNum=<%=i%>">[<%=i%>]</a>&nbsp;&nbsp;&nbsp;            
